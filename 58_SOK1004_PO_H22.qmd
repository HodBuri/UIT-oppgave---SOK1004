...
graph_Arbeidslose_df <- function(year_range, text_offset, papir_x_pos,bar = FALSE){
  #Graph Label
...
suppressWarnings({
graph_Arbeidslose_df(c(1915:1950), c(-4,-2),1929) 
})

# focus on 1920-1930
suppressWarnings({
graph_Arbeidslose_df(c(1920:1930), c(0,-2),1928.3)
})

# focus on 1920-1930, med bar
suppressWarnings({
graph_Arbeidslose_df(c(1920:1930), c(0,-2),1928.3,TRUE) 
})
...
Så fra disse figurene kan vi set at paripolitikken var starten av noe som hadde en effect på det norske arbeidsmarkede helt frem til 1940 - 1945, og først etter andre verdens krig ser vi at arbeidsledigheten går tilbake til det den var før 1920.
