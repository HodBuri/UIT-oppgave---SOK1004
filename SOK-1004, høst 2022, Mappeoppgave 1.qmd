...
oecd_n %>%
  ...
  labs (title = "GINI gjennom år delt på alders gruppe", y = "GINI", x= "Year - (2008-2019)", subtitle = "GINI  - disposable income, post taxes and transfers\nGINIB - market income, before taxes and transfers\nGINIG - gross income, before taxes",color="AGE GROUP")+
...
#scale_colour_manual(labels = c("above 65", "Total population","18-65"), values = c("#ffa822", "#ff6150","#1ac0c6"))+
```
